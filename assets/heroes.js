...
window.WOS_HEROES = (function() {
  const HEROES = [
    ...
    /* ===== 第2世代 ===== */
    {
      ...
      gen: 2,
      rar: 'SSR',
      joiner: { label: '炎上20%/3T(期待+20%)', parts: [{ k: 'chanceUptime', p: .2, dur: 3, v: .40 }] },
    ...
    },
    {
      ...
      leader: { label: '攻撃15', parts: [{ k: 'atk', v: .15 }] },
      syn: { lan: .03 }
    },
    {
      id: 'alonso',
    ...
    /* ===== 第3世代 ===== */
    {
      ...
      gen: 3,
      rar: 'SSR',
      joiner: { label: '追撃20%/3T(期待+20%)', parts: [{ k: 'chanceUptime', p: .2, dur: 3, v: .40 }] },
      leader: null
    },
    {
      id: 'mia',
    ...
    { id: 'ahmose', name: 'アクモス', cls: 'inf', gen: 4, rar: 'SSR' },
    {
      ...
      rar: 'SSR',
      gear: { type: 'leth', min: .05, max: .15, label: '集結殺傷+5→15%' },
      joiner: { label: '通常攻撃ダメ+30%(troop限定)', parts: [{ k: 'dmg', v: .30 }] },
      leader: {
    ...
    },
    {
      ...
      gen: 8,
      rar: 'SSR',
      joiner: { label: '敵防御-25%(被ダメ増)', parts: [{ k: 'defdown', v: .25 }] },
      leader: { label: '敵防御-25%(被ダメ増)', parts: [{ k: 'defdown', v: .25 }] },
      syn: { mks: .05 }
    },
    /* ===== 第9世代 ===== */
    {
