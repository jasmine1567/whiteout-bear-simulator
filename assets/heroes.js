...
const HEROES = [
 ...
 {id:'hector', name:'ヘクトー', cls:'inf', gen:5, rar:'SSR',
  joiner:null,
  leader:{label:'盾優先:与ダメ減衰(盾200/弓100%)+25%追撃',
