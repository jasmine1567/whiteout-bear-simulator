...
const HEROES = [
 ...
 {id:'hendrik', name:'ヘンドリック', cls:'mks', gen:8, rar:'SSR',
  joiner:{label:'敵防御-20%(被ダメ増)', parts:[{k:'defdown',v:.2}]},
  leader:{label:'敵防御-25%(被ダメ増)/弓与ダメ', parts:[{k:'defdown',v:.25},{k:'tDmg',cls:'mks',v:.2}]}, syn:{mks:.05}},
 /* ===== 第9世代 ===== */
