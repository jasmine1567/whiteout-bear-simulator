...
(function(){
  ...
  var NAV = EN ? {
    ...
    ratio:"Troop Ratio", doctor:"Damage Doctor", castle:"Castle Battle", foundry:"Foundry", cmd:"Commander", heroes:"Heroes", guide:"Guides"
  } : {
    brand:"🐻 ホワサバ ツールラボ", home:"ホーム", sim:"熊狩シミュ", left:"左英雄チェッカー",
    ratio:"兵士比率", doctor:"ダメージ診断", castle:"王城戦", foundry:"兵器工場戦", cmd:"指揮官診断", heroes:"英雄一覧", guide:"攻略ガイド"
  };
  function langLink(){
    return EN
