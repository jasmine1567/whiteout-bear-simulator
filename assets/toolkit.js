...
(function(){
  ...
  var NAV = EN ? {
    ...
    ratio:"Troop Ratio", doctor:"Damage Doctor", castle:"Castle Battle", foundry:"Foundry", frost:"Frost Dragon", cmd:"Commander", heroes:"Heroes", guide:"Guides"
  } : {
    brand:"🐻 ホワサバ ツールラボ", home:"ホーム", sim:"熊狩シミュ", left:"左英雄チェッカー",
    ratio:"兵士比率", doctor:"ダメージ診断", castle:"王城戦", foundry:"兵器工場戦", frost:"霜竜配置", cmd:"指揮官診断", heroes:"英雄一覧", guide:"攻略ガイド"
  };
  function langLink(){
    return EN
  ...
  window.WOS_NAV = function(depth){
    ...
    return SPRITE+'<nav class="sitenav"><div class="in">'
      ...
      +'<a href="'+d+'tools/frost-dragon/index.html">'+NAV.frost+'</a>'
      +'<a href="'+d+'tools/commander-type/index.html">'+NAV.cmd+'</a>'
      +'<a href="'+d+'tools/hero-list/index.html">'+NAV.heroes+'</a>'
